...
In 1983, white families had `$92,045` in median more wealth normalized to 2016 than black famlies. By 2016, the disparity in family wealth grew to `$153,591`. Notably, the largest disparity between white and black families is `$174,304` in 2007. When global recession continues, the median wealth in white families droped dramatically by `$50,000` in the next three years while in black families only dorped a little.
